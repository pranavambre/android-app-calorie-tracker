...
public class AdminAddOwner extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AdminAddOwner
     */
    String firstname, address, lastname,password, confirmPassword, emailId,phone;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter Details of Owner");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        AdminAddOwner ao = new AdminAddOwner();
        ao.setVisible(false);
        ah.setVisible(true);
        dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        lastname = jTextField2.getText().toString();
        address = jTextField4.getText().toString();
        password =  jTextField6.getText().toString();
        confirmPassword = jTextField7.getText().toString();
        emailId = jTextField3.getText().toString();
        phone = jTextField5.getText().toString();

        Owner_Controller rc = new Owner_Controller();
        String msg = rc. writeOwnerRegistrationValues(firstname, lastname, address, password, confirmPassword, emailId, phone);
